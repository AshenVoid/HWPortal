...
class ProcessorsAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Základní informace", {"fields": ("name", "manufacturer", "socket")}),
        (
            "Technické specifikace",
            {"fields": ("tdp", "corecount", "smt", "clock", "benchresult")},
        ),
        ("Ekonomické údaje", {"fields": ("price", "rating", "dateadded")}),
    )
...
class RamAdmin(admin.ModelAdmin):
    ...
    ordering = ["manufacturer", "name"]
    fieldsets = (
        ("Základní informace", {"fields": ("name", "manufacturer", "type")}),
        ("Technické specifikace", {"fields": ("capacity", "clock")}),
        ("Ekonomické údaje", {"fields": ("price", "rating", "dateadded")}),
    )
...
class GraphicsCardsAdmin(admin.ModelAdmin):
    ...
    ordering = ["manufacturer", "name"]
    fieldsets = (
        ("Základní informace", {"fields": ("name", "manufacturer")}),
        ("Technické specifikace", {"fields": ("vram", "tgp")}),
        ("Ekonomické údaje", {"fields": ("price", "rating", "dateadded")}),
    )
...
class StorageAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Základní informace", {"fields": ("name", "manufacturer", "type")}),
        ("Technické specifikace", {"fields": ("capacity",)}),
        ("Ekonomické údaje", {"fields": ("price", "rating", "dateadded")}),
    )
...
class PowerSupplyUnitsAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Základní informace", {"fields": ("name", "manufacturer")}),
        ("Technické specifikace", {"fields": ("maxpower",)}),
        ("Ekonomické údaje", {"fields": ("price", "rating", "dateadded")}),
    )
...
class ReviewsAdmin(admin.ModelAdmin):
    ...
    list_filter = ["component_type", "rating", "is_published", "date_created", "author"]
    ...
    fieldsets = (
        ...
        ("Obsah recenze", {"fields": ("summary", "content", "rating")}),
        ("Klady a zápory", {"fields": ("pros", "cons"), "classes": ("collapse",)}),
        (
            "Komponenta",
            {
                "fields": (
